...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HyBaseComponents/HyBaseComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HyCategoriess/HyCategoriess.framework"
